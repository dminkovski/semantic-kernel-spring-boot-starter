...
If you want to use this extension, you need to add the `io.quarkiverse.semantickernel:quarkus-semantic-kernel` extension first to your build file.
...
include::includes/quarkus-semantic-kernel.adoc[leveloffset=+1, opts=optional]
